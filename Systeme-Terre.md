...
> * Certains mécanismes sont "bottom-up" (proies -> prédateurs) : les plantes peuvent être en partie inaccessibles aux prédateurs à cause de leur position géographique. Elles peuvent aussi contenir du poison ou d'autres défenses contre les prédateurs, ou bien ne pas être suffisamment riches en nutriments pour être intéressantes à la consommation.
...
-  it is clear that herbivores do indeed have a measurable impact on the physical structure and species composition of vegetation, yet we still have to explain why the heavily grazed land around these exclosures was still ‘green’, as food for herbivores is apparently still available but not being used.

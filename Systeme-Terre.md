...
L’hypothèse est rapidement critiquée par les biologistes de l’évolution de renom, en particulier Richard Dawkins et Ford Dolittle. 
...
- Ce manque de mécanisme de régulation à échelle planétaire a été comblé en 1983, lorsque Lovelock et son collègue Andrew Watson publient [le modèle Daisyworld](https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1600-0889.1983.tb00031.x) (littéralement : le monde des pâquerettes). Ce modèle illustre comment des boucles de rétroaction entre la vie et l’environnement pourraient réguler la température globale.
> Daisyworld est une planète virtuelle orbitant autour d'une étoile similaire à notre Soleil. Une simple boule orbitant autour d’une étoile dont la luminosité augmente au fil des milliards d’années. Sur Daisyworld, il n’y a que 2 formes de vie : des paquerettes (?) blanches, et des pâquerettes noires. Les fleurs blanches reflètent complètement le rayonnement solaire. Elles refroidissent donc la planète. A l’inverse, les fleurs noires absorbent complètement le rayonnement solaire. Et donc elles réchauffent la planète.

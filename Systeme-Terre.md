...
- [Interactive : Satellites and climate change](https://www.carbonbrief.org/interactive-satellites-used-monitor-climate-change/) - Carbon Brief
...
- Energy Saturation.The sun puts out a lot of energy. It is possible that therewas no need to try and capture all of the spectrum or that it was actually not beneficial to do so. Often too much sun is more an issue than too little. Too much sun and heat can dry out the plant. It is possible that to gain the benefits of photosynthesis there needed to be a reduction in some energy  to  balance  it  out.  Much  like  a  black  car  on  a  hot  summer  day  a  black  plant  might absorb  all  of  the  spectrums  but  also  get  far  too  hot. Blue  plus  red  may  just  be  the  sweet spot.
...
- En écologie végétale, il existe une question classique qui fait débat depuis plusieurs décennies : "pourquoi le monde est-il vert ?"
> Certaines étendues terrestres apparaissent vertes depuis l'espace, à cause de la chlorophylle contenue dans les plantes. Mais si les plantes sont la source de nourriture des animaux, les animaux devraient logiquement manger le plus de plantes possibles, et transformer une terre verte en terre brune. Pourquoi n'est-ce pas le cas ?
- Cette question a été posée pour la première fois en 1960 dans un célèbre article intitulé "Community Structure, Population Control, and Competition" écrit par les écologues américains Nelson Hairston, Frederick Smith et Lawrence Slobodkin.
> Les 3 chercheurs proposent leur propre réponse à cette question. Selon leu, les herbivores ne parviennent pas à consommer toutes les plantes parce que leur population est controlée par les prédateurs. C'est l'idée de contrôle "top-down" de la population (prédateurs-> proies). A contrario, lorsque les prédateurs sont éliminés du paysage, il peut y avoir une prolifération incontrôlée d'herbivores (rongeurs ou insectes, par exemples) qui peut conduire à la destruction totale de la couverture végétale. Mais ce genre de prolifération est rare dans la nature. 
- Mais il y a aussi d'autres mécanismes qui peuvent limiter l'efficacité des herbivores. 
> * Certains mécanismes sont "bottom-up" (proies -> prédateurs) : les plantes peuvent être en partie inaccessibles aux prédateurs à cause de leur position géographique. Elles peuvent aussi contenir du poison ou d'autres défenses contre les prédateurs (comme des épines ou des composés comme les tannins qui les rendent moins bons), ou bien ne pas être suffisamment riches en nutriments pour être intéressantes à la consommation, ou encore être trop complexes à digérer (à cause de la lignine ou de la cellulose). Certaines plantes parviennent même à se cacher de leurs prédateurs, comme les Lithops, qu'on retrouve dans les régions arides de l'Afrique de Sud et de la Namibie, qui ont la forme et la couleur des pierres environnantes.
> * D'autres sont de nature spatiale : Les plantes ont peut être une étendue spatiale si grande qu'elles ne peuvent pas être intérgalement trouvées par les herbivores.
> * D'autres encore sont de nature climatique : les feux par exemple (causés par des éclairs ou des coulées de lave) peuvent agir comme un "herbivore global" qui consomme des plantes à grande échelle. Mais le taux d'oxygène atmosphérique est trop bas (21%) pour causer l'incinération de l'ensemble de la couverture végétale à l'échelle planétaire. Il faudrait pour cela des taux d'O2 supérieurs à 30%. Les facteurs climatiques peuvent aussi contraindre le nombre d'herbivores.
> * La compétition inter-espèce et intra-espèce entre différents herbivores peut aussi limiter le nombre d'herbivores à des nombres qui ne mettent pas en péril la couverture végétale.
- Pour tester les hypothèses "top down", les écologues utilisent des expériences à base d'enclos pour limiter artificiellement la densité d'herbivores. Ils et elles ont aussi recours à de l'observation détaillée d'écosystèmes sur plusieurs années.
> Ces analyses suggèrent que les processus qui contrôlent la population des herbivores ont un effet notable sur la composition et la distribution des plantes, mais en règle générale, ils ne suffisent pas à eux seuls à transformer une Terre "verte" en une Terre "brune", même lorsque l'on a retiré tous les prédateurs des herbivores.
- Tester les hypothèses "bottom up" présenter beaucoup plus de difficultés, vu qu'on ne peut pas vraiment modifier la chimie des plantes dans un contexte naturel.
- Le rôle des micro-organismes dans cette dynamique commence à peine à être étudié.
> * Certains microbes produisent par exemple des antibiotiques qui protègent certains arbres des attaques des champignons.
> * A contrario, les microbes qui vivent dans les intestins de nombreux mammifères peuvent faciliter la digestion des plantes par les herbivores.
- Il n'y a à ce jour aucun consensus sur la manière dont ces mécanismes "top down", "bottom up" et autres interagissent entre eux pour structurer les écosystèmes terrestres.
> Le point de vue majoritaire semble cependant être que les processus bottom-up sont les plus importants pour maintenir le monde vert. Autrement dit, les populations d'herbivores ont tendance à être limitées par leurs ressources en nourriture plutôt que par leurs prédateurs. Par contre, les processus top-down peuvent déterminer le type de végétation que l'on retrouve dans un environnement donné.

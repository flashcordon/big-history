...
> * D'autres encore sont de nature climatique : les feux par exemple (causés par des éclairs ou des coulées de lave) peuvent agir comme un "herbivore global" qui consomme des plantes à grande échelle. Mais le taux d'oxygène atmosphérique est trop bas (21%) pour causer l'incinération de l'ensemble de la couverture végétale à l'échelle planétaire. Il faudrait pour cela des taux d'O2 supérieurs à 30%.
...
- Il n'y a à ce jour aucun consensus sur la manière dont ces mécanismes "top down" et "bottom up" interagissent pour structurer les écosystèmes terrestres.
> Le point de vue majoritaire semble être que les processus bottom-up sont les plus importants pour maintenir le monde vert. Autrement dit, les populations d'herbivores ont tendance à être limitées par leurs ressources en nourriture plutôt que par leurs prédateurs. Par contre, les processus top-down peuvent déterminer le type de végétation que l'on retrouve dans un environnement donné.

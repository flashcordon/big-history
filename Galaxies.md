...
- The Hubble Ultra Deep Field from 2004 represents the deepest portrait of the visible universe ever achieved by humankind. Using the improved capabilities of the Advanced Camera for Surveys, the camera installed during the 2002 servicing mission, a new Deep Field was observed, in the constellation of Fornax (the Furnace). It reveals some of the first galaxies to emerge from the "dark ages", the time shortly after the Big Bang when the first stars reheated the cold, dim universe. The Ultra Deep Fields show the furthest away galaxies that can be observed in visible light.

...
- Lorsque ces particules très énergétiques arrivent dans le voisinage de la Terre, elles sont piégées dans le bouclier magnétique de la Terre. Ca c'est une très bonne nouvelle pour nous, les terriens, parce que ça veut dire que la plupart de ces particules ne nous tombent pas sur la tête, et les rares particules qui arrivent par le pôle nord et le pôle sud servent à créer de magnifiques spectacles lumineux qu'on appelle des aurores boréales et australes. Mais pour des astronautes qui voudraient s'extraire du voisinage de la Terre, c'est une moins bonne nouvelle, parce que les particules chargées ont tendance à s'accumuler dans une vaste région autour de la planète, et cette région est donc très radioactive.
- Pourquoi on l'appelle ceinture de Van Allen ? Parce qu'elle a été découverte à la fin des années 50 (1958) par le scientifique américain James van Allen (rien à voir avec le groupe de hard rock).

...
- The lander also has a wet chemistry laboratory unit (WCL), where it can mix Martian soil in liquid water. The unit consists of four such cells, each designed for a single use. The resulting aqueous solution is analyzed by ion-selective electrodes, which provide information on the compounds in the soil (such as salts) that are soluble in liquid water.

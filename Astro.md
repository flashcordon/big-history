...
> C’est la présence de certains isotopes radioactifs comme le magnésium 26 en excès dans certaines météorites (comme celle d’Allende) qui pointe vers la possibilité d’une supernova qui aurait éjecté ses éléments dans le système solaire primitif (dont l’aluminium 26 qui se serait depuis désintégré radioactivement en magnésium 26) :) Mais il y a d’autres hypothèses, comme une géante rouge voisine par exemple.

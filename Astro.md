...
- cette énergie du vide, au lieu de se diluer avec l'expansion, reste à peu près constante
...
- [NASA Recreates Odor of Saturn's Moon Titan](https://www.discovermagazine.com/the-sciences/nasa-recreates-odor-of-saturns-moon-titan) - Discovery Magazine
- [NASA Has Figured Out What Titan Smells Like](https://io9.gizmodo.com/nasa-has-figured-out-what-titan-smells-like-1591386080) - io9
- [Titan's atmosphere and climate](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1002/2016JE005240) - Horst (2017)
...
> * Hypothèse 1 : le vent solaire apporte des ions à la surface de la Lune, et se combinent à l'air du module pour donner cette odeur
> * Hypothèse 2 : la poussière lunaire s'oxyde en présence de l'oxygène, et cette oxydation produit l'odeur de poudre à canon
> * Hypothèse 3 : la poussière lunaire est chimiquement réactive et s'attache chimiquement aux récepteurs de votre nez
...
- Bon, voilà pour les témoignages directs. Tant qu'on est pas allé sniffer d'autres planètes, on ne peut pas faire grand chose de plus, n'est-ce pas ? Et bien si. On peut. Il y a quelques années, le génial professeur Farnsworth a dévoilé dans les postes de télé du monde entier une invention révolutionnaire : le smelloscope, une invention qui permet de sentir des odeurs provenant d'objets à grande distance. Ca a l'air d'être un objet de science-fiction comme ça, mais à mon avis, le smelloscope n'est pas un instrument aussi sophistiqué qu'il en a l'air. Et grâce à mes compétences supérieures en rétro-ingéniérie, je vais vous dévoiler son fonctionnement probable. Bon, ça reste entre nous hein. 
- Et si je vous disais que le smelloscope n'est rien de plus qu'un instrument à convertir la lumière d'un astre... En odeurs ? Bon, jusque-là ça semble toujours très futuriste. Mais en pratique, qu'est ce qui nous faudrait pour reproduire l'odeur d'un astre, ou d'une partie d'un astre ? Il nous faudrait simplement sa composition chimique. Mais pour cela, on a déjà des instruments, et les astronomes s'en servent au quotidien. Ces instruments, on le appelle des spectromètres.
- Un spectromètre, c'est une machine qui décompose la lumière d'un astre en ses couleurs individuelles, à la manière d'un prisme. Lorsque les molécules de l’espace entrent en collision, elles tournent, vibrent et se tordent. Ces mouvements produisent de la lumière, ou plus précisément des rayonnements électromagnétiques à des longueurs d'onde très particulières, qui dépendent de la nature des molécules. Les données provenant d'un spectromètre s'appellent un spectre. Et si on identifie la signature spectrale de ces molécules, on a donc accès à la composition chimique de ce qu'on observe. Il ne reste plus alors qu'à reproduire sur Terre la composition chimique exacte du corps céleste de votre choix, et voilà ! Vous avez votre smelloscope. C'était pas si compliqué.
- Et reproduire la composition chimique d'une atmosphère lointaine, c'est exactement ce qu'on fait des chercheurs de la NASA en 2014.

- ***Titan*** : La sonde Cassini, qui a orbité autour de Saturne et de ses lunes entre 2004 et 2017, s'est particulièrement intéressé à son plus gros satellite : Titan. Titan, c'est vraiment un monde à part entière dans le système solaire. Tout d'abord, c'est la seule lune du système solaire qui possède une atmosphère dense. Elle est recouverte d'une sorte de smog qui lui donne cette teinte orangée caractéristique. Plus étrange encore, elle possède des étendues de liquide à sa surface ! Bon alors ce n'est clairement pas de l'eau liquide, vu que Titan se trouve 10 fois plus loin du Soleil que la Terre, et qu'il fait -180°C à sa surface. Les seuls composés à l'état liquide dans ces conditions de température et de pression, ce sont des hydrocarbures (des assemblages de carbone et d'hydrogène), comme le méthane et d'éthane. Dans des conditions aussi exotiques, on peut se demander ce qu'on sentirait si on était à la surface de Titan. Il n'est pas conseillé d'enlever votre casque sur place, si vous ne voulez pas mourir de froid et asphyxié. Mais il exite une autre manière de sniffer l'atmosphère de Titan en toute sécurité. En 2014, des chercheurs de la NASA se sont servi des données du spectromètre infrarouge de la sonde Cassini (Composite Infrared Spectrometer) pour reproduire l'atmosphère de Titan en laboratoire. Ce qui n'est pas une mince affaire, parce que l'atmosphère de Titan est remplie de molécules diverses et complexes. Les données qu'ils avaient, c'était la signature spectroscopique de l'atmosphère de Titan. Et en réalisant diverses mixtures de gaz différents, ils ont essayé de faire correspondre la signature spectroscopique de leur mixture à celle de de l'atmosphère de la lune de Saturne. C'est un peu de la cuisine, mais ils ont fini par réussir ! Alors, c'est quoi leur recette ? Ils ont commencé par les gaz les plus abondants : l'azote (N2) et le méthane (CH4). Qui sont tous les 2 des gaz non odorants. Et ils ont ajouté à ce mélange des assemblages complexes de carbone, d'hydrogène et d'azote qu'on appelle des composés aromatiques (des molécules dont les atomes sont arrangés de façon à former une structure cyclique plane), des composés qu'on retrouve notamment dans le charbon et le pétrole. Ce mélange donne donc à Titan une forte odeur d'essence. La prochaine fois que vous vous trouvez dans une station service, fermez les yeux et imaginez-vous au bord d'un lac d'hydrocarbure sur Titan.
- ***67P/Tchourioumov-Guérassimenko*** : En 2014, l'instrument ROSINA (Rosetta Orbiter Spectrometer for Ion and Neutral Analysis) de la sonde Rosetta a analysé à l'aide de son spectromètre de masse les gaz éjectés par la comète Tchouri dans sa chevelure (ie son atmosphère). La chevelure est en grande partie composée de vapeur d'eau, de dioxide de carbone et de monoxide de carbone, qui ne sentent rien du tout. Mais parmi les gaz détectés, on y trouve aussi du sulfure d'hydrogène (H2S), qui sent l'oeuf pourri, de l'ammoniac (NH3) qui donne son odeur caractéristique à l'urine de chat, et du formaldéhyde (CH2O), à l'odeur âcre et piquante. On y trouve aussi du cyanure d'hydrogène (H-C≡N), un composé toxique qui dégage une odeur d'amande amère, et quelques tons d'alcool (méthanol CH3OH), de vinaigre (dioxide de soufre SO2) et une odeur qui ressemble à du chloroforme (disulfure de carbone CS2). Vous n'avez pas envie de sentir Tchouri. Mais si vous y tenez, une entreprise anglaise, The Aroma Company, spécialisée en "marketing multisensoriel", a créé un parfum nommé "eau de comète" basé sur la comète 67P. Ils ont évidemment pensé à remplacer les produits toxiques par des composés à l'odeur proche. Selon le journaliste Jacob Aron du New Scientist, qui l'a testé, "c'est pas si mal". [Super infographie des différentes espèces moléculaires détectées dans 67P](https://blogs.esa.int/rosetta/2016/09/29/the-cometary-zoo/)
...
- On dispose désormais d'une nouvelle technique pour détecter des trous noirs, et cette technique a fait ses preuves très récemment.
- Dans une étude publiée le 11 Novembre dernier dans la revue "Monthly Notices of the Royal Astronomical Society", une équipe internationale d'astronomes a annoncé la première détection directe d'un trou noir (NGC 1850 BH1) situé dans un amas d'étoiles hors de notre galaxie.
- Ce trou noir se trouve dans un amas (ouvert) d'étoile nommé NGC 1850 situé à 160 000 années-lumière d'ici, dans le grand nuage de Magellan, une galaxie naine de notre voisinage galactique.
> Il s'agit d'un amas contenant des milliers d'étoiles essentiellement jeunes puisque la plupart d'entre elles ont moins de 100 millions d'années 
- Pour détecter ce trou noir, les astronomes ont eu recours à une méthode qui est d'ordinaire utilisée pour détecter des exoplanètes : la méthode des vitesses radiales.
> * En gros, lorsque vous avez deux astres qui sont gravitationnellement liés, qui sont en couple donc (on appelle ça un système binaire), la lumière qui nous parvient de ces astres peut être décalée vers le bleu ou le rouge selon qu'elle s'éloigne ou qu'elle se rapproche de l'observateur. Quand on observe un système binaire, on s'atttend donc à voir des oscillations périodiques de la lumière des astres en couple
- Dans le cas qui nous intéresse, les astronomes ont observé l'amas d'étoiles avec l'instrument MUSE du Very Large Telescope au Chili, et ils ont observé une étoile qui présentait ces oscillations caractéristiques. Sauf qu'elle était dans un système binaire avec un compagnon invisible. Et bien ce compagnon invisible, c'est un trou noir
- Par définition, un trou noir n'émet pas de lumière.
...
- Eh bien maintenant on a une nouvelle méthode, la méthode des vitesses radiales, qui va nous permettre de détecter plein de nouveaux trous noirs à partir des mouvements orbitaux qu'elles génèrent sur leur étoile compagnon lorsque celle-ci est très rapprochée.
> * Cette étoile fait environ 5 fois la masse du Soleil et elle est 2 fois plus proche du trou noir que la distance Soleil Mercure. Elle commence même à être distordue par les forces gravitationnelles du trou noir. On pense qu'elle devrait finir à terme par se faire vampiriser les couches de gaz externes par le trou noir. 
...
> * Cet instrument est un spectrographe à intégrale de champ. C'est un instrument qui réalise non seulement une image très détaillée d'une collection d'étoiles, mais chaque pixel du détecteur peut aussi décomposer la lumière qu'elle reçoit en ses couleurs élémentaires, donner son spectre donc. Et on peut ainsi mesurer très finement le décalage vers le bleu ou le rouge des astres que l'on observe.
...
- Pour confirmer leur détection, les astronomes ont utilisé les données du télescope spatial Chandra, qui observe l'univers dans le domaine des rayons X, et ils ont effectivement observé une faible émission de rayons X à l'endroit où devrait se trouver le trou noir, ce qui augmente encore le degré de confiance dans leur résultat.
- Les astronomes ont même pu mesurer la masse du trou noir à partir des données du télescope spatial Hubble et d'une expérience appelée OGLE (Optical Gravitational Lensing Experiment) 
> Celui-ci fait environ 11 fois la masse du Soleil
- C'est la première fois qu'on découvre un tel objet avec cette méthode dans un jeune amas d'étoiles massif.
...
- [James Webb Space Telescope: le compte à rebours est lancé](https://www.cea.fr/multimedia/Documents/publications/les-defis-du-cea/les-defis-du-CEA-221.pdf.pdf) - Défis du CEA (2017)
...
- [Exclusive: Documents reveal NASA’s internal struggles over renaming Webb telescope](https://www.nature.com/articles/d41586-022-00845-6) - Nature

---

- Le JWST est aussi entouré de polémiques autour de son nom. En général, les télescopes spatiaux ont tendance à être nommés d'après des scientifiques. Mais en 2002, l'administrateur de la NASA Sean O'Keefe a décidé de nommer le successeur de Hubble James Webb, du nom de l'administrateur de la NASA à la tête de l'agence à l'époque des missions Apollo. La décision a été très impopulaire chez les astronomes, parce que James Webb aurait participé à une vague de persécution des homosexuels dans les années 50 et 60 (la peur violette) qui a mené à un licenciement massif d'employés gay et lesbiennes de la NASA. L'année dernière, une pétition a été lancée par 1200 astronomes à travers le globe pour renommer le télescope spatial... Sans succès. La NASA a lancé une investigation en interne, et a conclu publiquement qu'il n'y avait aucune preuve pour soutenir cette allégation, mais l'enquête elle-même est controversée à cause de son manque de transparence sur ses méthodes et ses conclusions.

## Lancement

- Le 11 Décembre dernier le télescope a été placé à l'intérieur de la coiffe d'un lanceur Ariane 5
- Le JWST a été lancé le 25 Décembre 2021 à 13h20 heure de Paris depuis le Centre Spatial Guyanais à Kourou, 32 ans avant les premiers croquis des ingénieurs de la NASA.
...
- Ce passage à travers la couronne solaire est le premier d'une longue série. Le prochain est prévu en Janvier 2022, et la sonde Parker devrait continuer de se rapprocher progressivement de notre étoile au fil de ses orbites jusqu'à atteindre environ 7 millions de kilomètres en 2025.

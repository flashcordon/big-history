...
> ***Processus s:*** Un noyau atomique capture un neutron et celui-ci se transforme en proton via désintégration radioactive (désintégration beta), ce qui transforme le neutrons en protons (et libère un électron et un antineutrino). Le noyau instable a le temps de se désintégrer radioactivement avant de capturer un autre neutron. Le nombre de protons de l'atome augmente ainsi petit à petit sur des centaines d'années. La création de noyaux atomiques par le processus s requiert des flux de neutrons relativement bas (~10^8 cm-3) et des températures de l'ordre de la centaine de millions de degrés. Il produit les éléments qui se trouvent sur la "vallée de la beta-stabilité". Le processus s se produit essentiellement dans la couche d'hélium de certaines géantes rouges (étoiles AGB de moins de 8 masses solaires)
